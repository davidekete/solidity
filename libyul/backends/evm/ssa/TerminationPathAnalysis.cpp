...
TerminationPathAnalysis::TerminationPathAnalysis(SSACFG const& _cfg, ForwardSSACFGTopologicalSort const& _topologicalSort):
...
bool TerminationPathAnalysis::blockAllowsAdditionOfJunk(SSACFG::BlockId const& _blockId) const
{
